execute as @a[tag=Pgroup] at @s run playsound minecraft:speedr.bgm record @s 15 -60 16 32767 1 1
execute as @a[tag=Pgroup] at @s run playsound minecraft:speedr.bgm record @s 372 -60 16 32767 1 1
